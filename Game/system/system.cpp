...
//CGraphicsEngine* g_graphicsEngine = NULL;	//グラフィックスエンジン。
...
void InitGame(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow, const TCHAR* appName)
{
	...
	//DirectXの初期化。
	//CGraphicsEngine* gra = new CGraphicsEngine();
	//SetGraphicsEngine(*gra) /*= new CGraphicsEngine()*/;
	//GraphicsEngine().Init(g_hWnd);
